        ...
        <section className="relative min-h-screen flex items-center overflow-hidden bg-dark-bg pt-20">
            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16 items-center relative z-10 w-full">
                ...
                >
                    ...
                    <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-[0.9] tracking-tighter text-white">
                    ...
                    <div className="flex items-center space-x-8 pt-8 border-t border-white/5">
                        ...
                        <p className="text-sm font-bold text-slate-500 uppercase tracking-widest">+1200 Artistes font confiance à Musik-Store</p>
                    </div>
                </motion.div>
                ...
                >
                    <div className="relative">
                        ...
                        >
                            <div className="w-14 h-14 bg-neon-pink rounded-2xl flex items-center justify-center text-white shadow-lg shadow-neon-pink/20">
                                <Music size={28} />
                            </div>
                            <div>
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Nouvelle Sortie</p>
                                <p className="text-sm font-black text-white uppercase">Single Distribué</p>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-10 -left-10 z-20 bg-dark-bg/40 backdrop-blur-xl p-6 rounded-3xl shadow-2xl border border-white/10"
                        >
                            <div className="flex items-center space-x-4">
                                <div className="w-10 h-10 bg-green-500/20 rounded-full flex items-center justify-center text-green-500 animate-pulse border border-green-500/30">
                                    <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">En Direct</p>
                                    <p className="text-lg font-black text-white">+105K STREAMS</p>
                                </div>
                            </div>
                        </motion.div>
